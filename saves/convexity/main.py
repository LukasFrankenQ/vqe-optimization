...
for angle in angles:
    ...
    for _ in range(runs):
        ...
        path = 'saves/convexity/'
        filename = 'tfi_'+str(n)+'_qubits_'+str(p)+'_layers_fubini_'+str(fubini)+"_rot_"+str(rot)+'_reg_param_'+str(reg_param)+'_grad_reps_'+str(grad_reps)+'_fb_reps_'+str(fb_reps)+'_blockwise_'+str(blockwise)+'_diagonal_only_'+str(diagonal_only)+'_'
